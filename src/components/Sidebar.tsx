...
export default function Sidebar() {
  ...
  return (
    ...
    >
      <Link to="/" className="block">
        ...
        >
          <div className="relative w-full h-full">
            <img src="/logo.png" alt="Logística ACME" className="w-full h-full object-contain" />
          </div>
        </div>
      </Link>
      ...
      <button
        className="absolute -right-3 top-20 bg-white rounded-full border border-gray-200 shadow-md hover:bg-gray-100 p-1"
